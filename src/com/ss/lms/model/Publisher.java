...
public class Publisher extends BaseModel {
		...
		public String toString() {
			...
			return "Publisher ID: " + publisherId + 
					...
					"\nPublisher Address: " + (publisherAddress != null ? publisherAddress : Util.fSysAlert.format("Address Empty")) +
					Util.fSysOutput.format("\nPublisher Phone: " + (publisherPhone != null ? publisherPhone : Util.fSysAlert.format("Phone Empty")));
		}
