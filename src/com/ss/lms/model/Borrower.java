...
public class Borrower extends BaseModel {
		...
		public String toString() {
			...
			return "Borrower CardNo: " + cardNo + 
					"\nBorrower Name: " + (borrowerName != null ? borrowerName: Util.fSysAlert.format("Name Empty"))+ 
					Util.fSysOutput.format("\nBorrower Address: " + (borrowerAddress != null ? borrowerAddress : Util.fSysAlert.format("Address Empty"))) +
					Util.fSysOutput.format("\nBorrower Phone: " + (borrowerPhone != null ? borrowerPhone : Util.fSysAlert.format("Phone Empty")));
		}
